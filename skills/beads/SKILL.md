...
1. Find your project's beads mount: `MOUNT=$(list_mounts.sh | grep "$(pwd)" | awk '{print $1}')`
2. If no mount exists, create one and use it: `mount_beads.sh "$(pwd)"`. The mount will be named for the base directory of $(pwd).
